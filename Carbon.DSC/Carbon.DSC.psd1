...
@{
    ...
    Description = 'A collection of helpful DSC resources.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.DSC'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.DSC/blob/main/CHANGELOG.md'
